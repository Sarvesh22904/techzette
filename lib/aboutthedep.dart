...
void main() {
  runApp(const AbouttheDep());
}

class AbouttheDep extends StatelessWidget {
  const AbouttheDep({Key? key});
  ...
  Future<String> fetchWebPage() async {
    ...
    final response = await http.get(Uri.parse(
        'https://techz.vcet.edu.in/artificial-intelligence-and-data-science'));
